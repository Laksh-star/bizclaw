...
function buildVolumeMounts(
  ...
  // Gmail credentials — mount read-write so MCP can refresh tokens
...
function readSecrets(): Record<string, string> {
  return readEnvFile(['CLAUDE_CODE_OAUTH_TOKEN', 'ANTHROPIC_API_KEY', 'OPENROUTER_API_KEY', 'OPENROUTER_DEFAULT_MODEL', 'TAVILY_API_KEY', 'TMDB_API_KEY']);
}
...
export function writeTasksSnapshot(
  ...
  // All groups see all tasks — agents need global context to avoid recreating existing tasks
