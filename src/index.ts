...
async function runAgent(
  ...
  prompt: string | import('./types.js').ContentBlock[],
  chatJid: string,
...
async function main(): Promise<void> {
  ...
  if (!TELEGRAM_ONLY) {
    ...
    // Connect in background — scheduler starts immediately so tasks don't miss
    // their window if WhatsApp takes time to reconnect. Task results queue and
    // flush once the connection opens.
